...
public class EdxIO implements Closeable {
  ...
  public byte currentSymbol() {
    return inputPosition < inputCapacity ? inputBuffer.get(inputPosition)
        : (byte) -1;
  }
  ...
  public void skipWhiteSpace() {
    while (inputPosition < inputCapacity
        && inputBuffer.get(inputPosition) <= 32) {
      ++inputPosition;
    }
  }
